...
<div id="wrapper">
    <div class="vertical-align-wrap">
        <div class="vertical-align-middle auth-main">
            <div class="auth-box">
                <div class="top">
                    <img src="{{('admin/assets/images/logo-white.svg')}}" alt="Lucid">
                </div>
                <div class="card">
                    <div class="header">
                    ...
                    <div class="body">
                        <form class="form-auth-small" method="POST" action="{{ route('login')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="signin-email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email">
                                @error('email')
