                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($categories as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('category.edit', $item->id)}}" data-toggle="tooltip" title="edit" data-placement="bottom" class="btn btn-sm btn-outline-warning"><i class="fas fa-edit"></i></a>
                                                <form class="float-right" action="{{route('category.destroy', $item->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
