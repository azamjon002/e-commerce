                            ...
                            <form action="{{route('category.update', $category->id )}}" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" type="text" class="form-control" placeholder="Write some words... "
                                                      name="description">{{$category->summary}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="" class="form-control" id="thumbnail" name="photo" value="{{$category->photo}}">
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-sm-12 my-3">
                                        ...
                                        <input id="is_parent" name="is_parent" type="checkbox" value="{{$category->is_parent}}" {{$category->is_parent == 1 ?'checked':''}} >  Yes
                                    </div>
