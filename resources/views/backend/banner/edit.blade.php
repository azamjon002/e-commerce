                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                    class="fa fa-arrow-left"></i></a>Update Banner</h2>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input type="" class="form-control" id="thumbnail" name="photo" value="{{$banner->photo}}">
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <select class="form-control show-tick" name="condition">
                                            ...
                                            <option value="prome" {{$banner->condition == 'prome' ? 'selected' : ''}}>
                                                Promote
                                            </option>
                                        </select>
                                    </div>
